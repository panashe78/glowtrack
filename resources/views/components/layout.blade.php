...
<body class="h-full bg-gray-100">
    ...
    <nav class="bg-blue-900 h-24 p-5 fixed w-full navbar" style="background: linear-gradient(135deg, white 20%, rgb(4, 4, 126) 20%);">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex h-16 items-center justify-between">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <x-navbar-link href="/contact" :active="request()->is('contact')">Contact</x-navbar-link>
                                ...
                                <button type="button" class="flex items-center justify-center focus:outline-none text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300 font-medium rounded-full text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-900 transition duration-300 ease-in-out transform hover:scale-105">
                ...
                <div class="-mr-2 flex md:hidden">
                    <button type="button" id="mobile-menu-toggle" style="color: white" class="relative inline-flex items-center justify-center rounded-m p-2 text-white hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" aria-controls="mobile-menu" aria-expanded="false">
        ...
        <!-- Mobile Menu -->
        <div class="sm:hidden xs:hidden md:hidden bg-blue-900 rounded-md hidden" id="mobile-menu">
            <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3" style="z-index: 1000;">
